...
export default function PhotographerReviews({ onBack }: { onBack: () => void }) {
        ...
        <View style={[styles.card, { backgroundColor: background }]}>
            <View style={styles.cardHeader}>
                ...
                <View style={styles.headerInfo}>
                    <ThemedText weight="bold" style={{ color: gray900 }}>{item.reviewer.full_name}</ThemedText>
            ...
            <ThemedText style={[styles.comment, { color: gray700 }]}>{item.comment || 'No comment provided'}</ThemedText>
        </View>
    );
    ...
    return (
        <View style={[styles.container, { backgroundColor: gray100 }]}>
            ...
            <View style={[styles.header, { paddingTop: insets.top + 16, backgroundColor: background }]}>
                ...
                <ThemedText type="lg" weight="bold" style={{ color: gray900 }}>Client Reviews</ThemedText>
                <View style={{ width: 40 }} />
            </View>
